const TastingNote = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center w-[335px] bg-white border-1 border-gray-400 rounded-lg pt-[32px] pb-[22px] px-[28px]">
        <div className="w-[291px] flex flex-col items-center gap-[32px]">
          <div className="flex flex-col justify-between gap-[12px] w-full">
            ...
            <p className="font-body text-body-5 text-black-2">
              ...
              감각적으로 표현하는 용어입니다.
              <br />
              와인을 맛볼 때 '과일 향'이나 '오크 향'을 느끼는 것 처럼, 차에서도
              꽃, 과일, 견과류 등 다양한 풍미를 발견할 수 있습니다.
              <br />
              <br />
