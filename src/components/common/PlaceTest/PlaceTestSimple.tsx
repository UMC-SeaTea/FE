    ...
    shadow-[0_0_4px_0_rgba(0,0,0,0.06),0_0_16px_0_rgba(94,94,94,0.04)] gap-[158px] items-center"
      >
        <div className="w-[119px] flex flex-col items-start gap-2">
          <div className="w-[52px] h-[22px] flex p-1 items-center justify-center gap-2.5 rounded-[2px] bg-[#DADEFF]">
            <p className="font-body text-detail-3 text-brand whitespace-nowrap">
              지금 바로
            </p>
          </div>
