...
const LoginStartPage = () => {
  ...
  return (
    <>
      <div
        className="w-full min-h-screen flex flex-col justify-between pt-[113px] pb-[92px] px-[20px]"
        style={{
          background: 'linear-gradient(180deg, #FFF 50%, #8097FF 100%)',
        }}
      >
        <div className="flex flex-col items-center gap-[4.89px]">
          <img
            src={loginLogo}
            alt="login logo"
            className="w-[198.109px] h-[198.109px] rounded-[25.157px]"
          />
        ...
        <div className="flex flex-col w-full gap-3">
          ...
          >
            <div className="text-footer font-body text-body-title mt-[4px] text-center">
              로그인
            </div>
          </div>
          ...
          >
            <div className="text-white font-body text-body-title mt-[4px] text-center">
              회원가입
            </div>
          </div>
          <div
          ...
          >
            ...
            />
            <div className="text-[#4A2219] font-body text-body-title mt-[4px]  text-center">
              카카오로 시작하기
            </div>
          </div>
        </div>
