...
const typeConfig: Record<string, { 
  ...
  floral: { img: Floral, width: '500px', rotate: '20.61deg', top: '-80px', right: '-245px' },
  nutty: { img: Nutty, width: '280px', rotate: '0deg', top: '0px', right: '-100px' },
  sweet: { img: Sweet, width: '230px', rotate: '0deg', top: '-120px', right: '0px' },
  spices: { img: Spices, width: '380px', rotate: '0deg', top: '-50px', right: '-170px' },
  smoky: { img: Smoky, width: '230px', rotate: '50deg', top: '0px', right: '-50px' },
  fruity: { img: Fruity, width: '800px', rotate: '-30deg', top: '-150px', right: '-350px' },
  oceanic: { img: Oceanic, width: '120px', rotate: '0deg', top: '30px', right: '0px' },
  earthy: { img: Earthy, width: '600px', rotate: '-20deg', top: '-70px', right: '-255px' },
};
...
const SpaceRecommendation = ({ type, title, subTitle }: SpaceRecommendationProps) => {
